<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <cmpOrderMain-modal ref="modalForm" @ok="modalFormOk"></cmpOrderMain-modal>
  </a-card>
</template>

<script>
  import CmpOrderMainModal from './modules/CmpOrderMainModal'
  import { CmpListMixin } from '@/mixins/CmpListMixin'

  export default {
    name: "CmpOrderMainList",
    mixins: [CmpListMixin],
    components: {
      CmpOrderMainModal
    },
    data () {
      return {
        description: '订单管理页面',
        importExcelUrl:`${window._CONFIG['domianURL']}/test/cmpOrderMain/importExcel`,
        // 表头
        columns: [
          {
            title: '#',
		...
		url: {
          list: "/test/cmpOrderMain/list",
          delete: "/test/cmpOrderMain/delete",
          deleteBatch: "/test/cmpOrderMain/deleteBatch",
          exportXlsUrl: "/test/cmpOrderMain/exportXls",
        }
      }
    },
    methods: {
